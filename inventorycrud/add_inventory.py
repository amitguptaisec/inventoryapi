...
def add_inventory(request):
    try:
        cursor.execute('CALL usp_inventory_add (%s,%s,%s,%s,%s);',(request.data['userName'], request.data['passWord'],request.data['Inventory_Name'],request.data['category_id'],request.data['quantity']))
        reslt = []
...
#     "userName":"amit",
#     "passWord":"abcd",
#     "Inventory_Name":"Wheat",
#     "category_id":3,//3:grains,2:fruit,1:mobile
#     "quantity":4
# }